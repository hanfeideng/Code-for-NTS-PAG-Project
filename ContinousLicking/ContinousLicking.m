...
% Code
% 1, water; 2, airpuff; 16, sucrose; 32, quinine; 64, water
LickPort = 'Port1In';
water_value_id = 1; % 7, 1
...
% RewardValveState = 64;
PunishValveState = 2;
RewardValveState = 2^(water_value_id-1);
...
for currentTrial = 1:MaxTrials
    ...
    R = GetValveTimes(S.GUI.RewardAmount, [water_value_id]);
    ...
    if S.GUI.TrainingLevel==1 % habituation
        ...
        sma = AddState(sma, 'Name', 'TrialStart', ...
            'Timer', 0.3,... % time before trial start
        ...
        if S.BaselineNoLick
            sma = AddState(sma, 'Name', 'TrialStart', ...
                'Timer', 2,...
                'StateChangeConditions', {'Tup', 'StimulusDeliver',LickPort,'TrialStart_Re'},...
                'OutputActions', {});
            sma = AddState(sma, 'Name', 'TrialStart_Re', ...
                'Timer', 0.5,...
