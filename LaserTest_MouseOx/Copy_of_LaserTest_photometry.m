...
if isempty(fieldnames(S))  % If settings file was an empty struct, populate struct with default settings
    ...
    S.LaserDelayFromTrialOnset = 4; % the onset of laser stimulation from trial onset
...
for currentTrial = 1:MaxTrials
    ...
    sma = SetGlobalTimer(sma, 'TimerID', 1, 'Duration', S.GUI.LaserDuration, 'OnsetDelay', 0, 'Channel', 'Wire1','BNC1');
    sma = SetGlobalTimer(sma, 'TimerID', 2, 'Duration', S.LaserDuration, 'OnsetDelay', S.LaserDelayFromTrialOnset, 'Channel', 'BNC2');
