...
switch Action
    case 'init'
        ...
        BpodSystem.GUIHandles.LevelLine = line([0,0],[0.1,0.1], 'LineStyle','none','Marker','*','MarkerEdge','k','MarkerFace',[1 1 1], 'MarkerSize',6);
        set(AxesHandle,'TickDir', 'out','YLim', [-2.5, 3.5], 'YTick', [-2 -1 0 1 2 3],'YTickLabel', {'Shock','Sham','Quin','Water','Suc','Odor'}, 'FontSize', 16);
    ...
    case 'update'
        ...
        if ~isempty(OutcomeRecord)
            ...
            %Plot Level            
            Xdata = 1:CurrentTrial-1; Ydata = TrialUSLevels*0.1;
            set(BpodSystem.GUIHandles.LevelLine, 'xdata', [Xdata,Xdata], 'ydata', [Ydata,Ydata]);
